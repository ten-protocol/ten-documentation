...
## Smart Contract Execution with Hidden State[​](#smart-contract-execution-with-hidden-state "Direct link to Smart Contract Execution with Hidden State")
...
## Data Access Control Primitives[​](#data-access-control-primitives "Direct link to Data Access Control Primitives")
...
## TEN Gateway[​](#ten-gateway "Direct link to TEN Gateway")
...
## Free Native On-Chain Randomness[​](#free-native-on-chain-randomness "Direct link to Free Native On-Chain Randomness")
...
## Precise Timestamping of Transactions[​](#precise-timestamping-of-transactions "Direct link to Precise Timestamping of Transactions")
...
## Native Commit-Reveal (Required by Many Games)[​](#native-commit-reveal-required-by-many-games "Direct link to Native Commit-Reveal (Required by Many Games)")
...
## Native Session Keys[​](#native-session-keys "Direct link to Native Session Keys")
